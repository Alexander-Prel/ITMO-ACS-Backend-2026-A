...
export const unavailable = () => new ApiError(503, "SERVICE_UNAVAILABLE", "Зависимый сервис недоступен.");
export const upstreamTimeout = () => new ApiError(504, "UPSTREAM_TIMEOUT", "Зависимый сервис не ответил вовремя.");
