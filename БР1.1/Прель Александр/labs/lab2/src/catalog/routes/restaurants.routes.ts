...
import { badRequest, notFound, ValidationErrorDetail } from "../../shared/errors";
...
import { asPositiveInt, asString, ensureValid } from "../../shared/validation";
...
restaurantsRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    res.status(201).json(toReviewResponse({ ...review, restaurant }));
  }),
);
