...
if (url.protocol !== "http:" || !["127.0.0.1", "localhost"].includes(url.hostname)) {
  throw new Error("Only local API targets are allowed");
}
...
const child = spawn("npx", [
  ...
  "newman@6.2.2",
  "run",
  path.join(hw3, "restaurant-booking-dz3.postman_collection.json"),
  "-e",
  path.join(hw3, "restaurant-booking-local.postman_environment.json"),
  "--env-var",
  `baseUrl=${baseUrl}`,
  "--reporters",
  "cli",
